...
//                        in.putExtra("ExerciseNum", 10);
                ...
                case 2: {
                    if(actName=="Practice") {
                        ...
                        in.putExtra("ImageToLoad", R.drawable.needless_pic_intro);
...
//                }
                ...
                case 12: {
                    if(actName=="Practice") {
                        ...
                        //  sp.play(bipSound, 1, 1, 0, 0, 1);
                        Intent in = new Intent(context, IntroTextForAllActivity.class);
                        in.putExtra("IntroText", (R.string.Intro1Text20));
                ...
                case 15: {
                    if(actName=="Practice") {
                        ...
                        in.putExtra("ImageToLoad", R.drawable.lines_intro);
                        in.putExtra("IntroReading", R.raw.zvukpravilno);
                        context.startActivity(in);
                    }
                ...
                case 18: {
                    if(actName=="Practice") {
                        ...
                        Intent in = new Intent(context, IntroTextForAllActivity.class);
                        in.putExtra("IntroText", (R.string.Intro1Text20));
                        in.putExtra("ExerciseNum",26);
                        in.putExtra("ImageToLoad", R.drawable.similsrity_cubes_intro);
                        in.putExtra("IntroReading", R.raw.zvukpravilno);
                        context.startActivity(in);
                    }
                ...
                case 19: {
                    if(actName=="Practice") {
                        ...
                        Intent in = new Intent(context, IntroTextForAllActivity.class);
                        in.putExtra("IntroText", (R.string.Intro1Text20));
                        in.putExtra("ExerciseNum",27);
                        in.putExtra("ImageToLoad", R.drawable.similarity_dice_intro);
                        in.putExtra("IntroReading", R.raw.zvukpravilno);
                        context.startActivity(in);
                    }
                ...
                case 20: {
                    if(actName=="Practice") {
                        ...
                        //  sp.play(bipSound, 1, 1, 0, 0, 1);
                        Intent in = new Intent(context, IntroTextForAllActivity.class);
                        in.putExtra("IntroText", (R.string.Intro1Text21));
                        in.putExtra("ExerciseNum",28);
                        in.putExtra("ImageToLoad", R.drawable.cube_bloks_intro);
                        in.putExtra("IntroReading", R.raw.zvukpravilno);
                        context.startActivity(in);
                    }
                ...
                case 21: {
                    if(actName=="Practice") {
                        ...
                        //  sp.play(bipSound, 1, 1, 0, 0, 1);
                        Intent in = new Intent(context, IntroTextForAllActivity.class);
                        in.putExtra("IntroText", (R.string.Intro1Text22));
                        in.putExtra("ExerciseNum",29);
                        in.putExtra("ImageToLoad", R.drawable.cubes_count_main);
                        in.putExtra("IntroReading", R.raw.zvukpravilno);
                        context.startActivity(in);
                    }
                ...
                case 22: {
                    if(actName=="Practice") {
                        ...
                        //  sp.play(bipSound, 1, 1, 0, 0, 1);
                        Intent in = new Intent(context, IntroTextForAllActivity.class);
                        in.putExtra("IntroText", (R.string.Intro1Text23));
                        in.putExtra("ExerciseNum",30);
                        in.putExtra("ImageToLoad", R.drawable.cubes_count_main);
                        in.putExtra("IntroReading", R.raw.zvukpravilno);
                        context.startActivity(in);
                    }
